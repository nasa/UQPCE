...
class TestGeneralVariable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.invgauss_samps = self.invgauss_var.resample(samp_size)
        self.invgauss_var.standardize('vals', 'std_vals')
        self.inv_warn = self.invgauss_var.check_distribution(self.invgauss_samps)
...
class TestUniformVariable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.unif_warn = self.unif_var.check_distribution(self.unif_var.vals)
...
class TestNormalVariable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.norm_warn = self.norm_var.check_distribution(self.norm_var.vals)
...
class TestBetaVariable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.beta_warn = self.beta_var.check_distribution(self.beta_var.vals)
...
class TestExponentialVariable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.exp_warn = self.exp_var.check_distribution(self.exp_var.vals)
        self.exp_samps = self.exp_var.resample(samp_size)
...
class TestGammaVariable(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.gamma_warn = self.gamma_var.check_distribution(self.gamma_var.vals)
        self.gamma_samps = self.gamma_var.resample(samp_size)
