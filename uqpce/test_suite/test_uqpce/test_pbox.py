...
class TestProbabilityBox(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.matrix_coeffs = np.atleast_2d(np.array([
    ...
    def test_generate_aleatory_samples(self):
        ...
        variables.
        """
        unique_samp_count = np.sum(np.unique(self.pbox.epist_resample, axis=0, return_counts=True)[1], axis=0)
    ...
    def test_generate_epistemic_samples(self):
        ...
        variables.
        """
        unique_samp_count = np.sum(np.unique(self.pbox.aleat_resample, axis=0, return_counts=True)[1], axis=0)

        self.assertTrue(
            (unique_samp_count == self.aleat_samps).all(),
