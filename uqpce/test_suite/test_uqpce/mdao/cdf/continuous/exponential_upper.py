...
if __name__ == '__main__':
    ...
    f.suptitle('Exponential Distribution', fontsize=tfs)
    f.legend(fontsize=12, bbox_to_anchor=(1.05, 1.1), fancybox=True, labelspacing=0.1)

    # plt.savefig('tanh_expon_upper', bbox_inches='tight')