...
if __name__ == '__main__':
    ...
    f.suptitle('Negative Binomial Distribution', fontsize=tfs)
    f.legend(fontsize=12, bbox_to_anchor=(1.13, 1.1), fancybox=True, labelspacing=0.1)

    # plt.savefig('tanh_negative_binomial', bbox_inches='tight')
