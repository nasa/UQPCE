...
if __name__ == '__main__':
    ...
    ax2.plot([x.min(), calc], [0.975, 0.975], 'r', ls='dotted')
    ...
    f.suptitle('Hypergeometric Distribution', fontsize=tfs)
    f.legend(fontsize=12, bbox_to_anchor=(1.1, 1.1), fancybox=True, labelspacing=0.1)

    # plt.savefig('tanh_hypergeometric', bbox_inches='tight')
