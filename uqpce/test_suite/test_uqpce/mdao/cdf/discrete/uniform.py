...
if __name__ == '__main__':
    ...
    f.suptitle('Discrete Uniform Distribution', fontsize=tfs)
    f.legend(fontsize=12, bbox_to_anchor=(1.11, 1.1), fancybox=True, labelspacing=0.1)

    # plt.savefig('tanh_discrete_uniform', bbox_inches='tight')