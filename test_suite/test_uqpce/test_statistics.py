...
class TestStatistics(unittest.TestCase):
    ...
    def test_calc_PRESS_res(self):
        ...
        new_basis = evaluate_points(var_basis_func, X)
    ...
    def test_get_sobol_bounds(self):
        ...
        self.assertTrue(
            sobol_CIL_calc[0,0] == 0, msg='get_sobol_bounds is not correct.'
        )

        self.assertTrue(
            sobol_CIH_calc[0,0] > 0.5, msg='get_sobol_bounds is not correct.'
        )
        ...
        # larger.
        self.assertTrue(
            sobol_CIL_calc[0,1] == 0, msg='get_sobol_bounds is not correct.'
        )

        self.assertTrue(
            sobol_CIH_calc[0,1] < 0.1, msg='get_sobol_bounds is not correct.'
        )
        ...
        # both be 0.
        self.assertTrue(
            sobol_CIL_calc[0,2] > 0 and sobol_CIL_calc[0,2] < 0.2,
            msg='get_sobol_bounds is not correct.'
        )

        self.assertTrue(
            sobol_CIH_calc[0,2] == 1, msg='get_sobol_bounds is not correct.'
        )
